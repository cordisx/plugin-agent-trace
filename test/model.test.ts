...
describe('Timeline model', () => {
  ...
  const events: readonly TraceEvent[] = Object.freeze([
    Object.freeze({ id: 'session:session-a:0', sessionId: 'session-a', seq: 0, recordedAt: '2026-01-01T00:00:00.000Z', lane: 'model', type: 'turn/start', semanticType: 'turn/start', phase: 'started', summary: 'Turn 1 started.', source }),
    Object.freeze({ id: 'session:session-a:1', sessionId: 'session-a', seq: 1, recordedAt: '2026-01-01T00:00:01.000Z', lane: 'tools', type: 'tool/call', semanticType: 'tool/call', summary: 'Tool call committed.', source, turnId: '1' }),
    Object.freeze({ id: 'session:session-a:2', sessionId: 'session-a', seq: 2, recordedAt: '2026-01-01T00:00:02.000Z', lane: 'model', type: 'turn/end', semanticType: 'turn/end', phase: 'completed', summary: 'Turn 1 ended.', source, turnId: '1' }),
  ])
